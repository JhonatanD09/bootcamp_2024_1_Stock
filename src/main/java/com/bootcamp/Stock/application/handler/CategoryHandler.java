...
import com.bootcamp.Stock.application.mapper.MapperCategoryRequest;
import com.bootcamp.Stock.application.mapper.MapperCategoryResponse;
import com.bootcamp.Stock.application.validators.ValidatorRequest;
...
public class CategoryHandler implements  IHandlerCategory{
    ...
    public void saveCategory(CategoryRequest categoryRequest) {
        if(categoryRequest.getDescription() == null || categoryRequest.getDescription().isEmpty()){
            ...
            if (ValidatorRequest.valideField(categoryRequest.getName(),50) &&
                    ValidatorRequest.valideField(categoryRequest.getDescription(),90)){
