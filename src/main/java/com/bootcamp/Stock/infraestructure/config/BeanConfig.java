...
import com.bootcamp.Stock.domain.usecase.ArticleUseCase;
import com.bootcamp.Stock.domain.usecase.CategoryUseCase;
import com.bootcamp.Stock.domain.usecase.TrademarkUseCase;
import com.bootcamp.Stock.infraestructure.out.adapter.ArticleJpaAdapter;
...
public class BeanConfig {
    ...
    public IArticlePersistencePort iArticlePersistencePort(){
        return  new ArticleJpaAdapter(iArticleRepository,iArticleCategoryRepository,iCategoryRepository,iTrademarkRepository,iArticleEntityMapper);
    }

    @Bean
    public IArticleServicePort iArticleServicePort(){
